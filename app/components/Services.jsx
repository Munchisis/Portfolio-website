  ...
  return (
    ...
    id='services' className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I provide a range of services to help you build and maintain your online presence. From web development to digital marketing, I have the skills and expertise to help you succeed.
      </motion.p>
      ...
      className='grid grid-cols-autofit gap-6 my-10 '>
        {serviceData.map(({icon, title, description, link}, index) =>(
            ...
            key={index} className='border border-gray-300 rounded-lg px-8 py-12 hover:shadow-black 
